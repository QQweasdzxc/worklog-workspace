...
4. Open **設定 → 我的工作**. Verify one workspace, card layout, tag/category filter, global sorting, and search.
...
- [ ] Work Memory is one workspace with card tiles, not category-separated groups.
- [ ] Search and category tags/filters work; sorting spans all cards globally.
