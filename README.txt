...
Before deploying, set GOOGLE_PICKER_API_KEY and GOOGLE_PICKER_APP_ID in app-config.js if Google Drive Picker UAT is required.
Do not put OAuth client secrets or Supabase service_role keys in this artifact.

This is a deployment artifact, not the source repository. Source is delivered separately as Sprint2/Source.zip.
