...
expect(app, '<div class="sidebar-version-summary"><span>Version</span><strong>v${escapeHtml(VERSION)}</strong></div>', "compact Version summary");
expect(app, '<div>Build：${BUILD_TIME}</div>', "Build moved into progressive version details");
